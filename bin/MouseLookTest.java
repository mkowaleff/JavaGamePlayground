...
/* A simple mouselook test. Using mouselook, the user can virtually move the mouse in any direction indefinitely.
 * Without mouselook, the mouse stops when it hits the edge of the screen.
 * 
 * Mouselook works by recentering the mouse whenver it is moved, so it can always measure the relative mosue movement,
...
public class MouseLookTest  extends GameCore implements MouseMotionListener, KeyListener {
	...
	public synchronized void draw(Graphics2D g) {
		...
		g.drawString("Press Space to change mouse modes.", 5, FONT_SIZE*2);	
	}
