...
// The KeyConfigTest class extends the MenuTest demo to add a dialog box
// to configure the keyboard keys.
...
public class KeyConfigTest extends MenuTest {
	...
	/* The InputComponent class displays the keys mapped to a particular action and allows the user to change
	 * the mapped keys. The user selects an InputComponent by clicking it, then can press any key or mouse
	 * button (including the mouse wheel) to change the mapped value.
	 */
	class InputComponent extends JTextField {
		...
		// Alternate way to intercept mosue events
