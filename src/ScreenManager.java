...
public class ScreenManager {
	...
	// 	Returns the first compatible mode in a list of modes. Returns null if no mdoes are compatible.
	...
	/* 	Determines if two display modes "match". Two display modes match if they have the same resolution, bit depth, 
	 * and refresh rate. The bit depth is ignored if one of the modes has a bit depth of DisplayMode.BIT_DEPTH_MULTI.
