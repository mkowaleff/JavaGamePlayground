...
import java.util.LinkedList;
	...
	/* A simple mouse test. Draws a "Hello World!" message at the location of the cursor.
	 * Click to change to "trail mode" to draw several messages. Use the mouse wheel (if
	 * available) to change colors.
	 */
public class MouseTest extends GameCore implements KeyListener, MouseMotionListener, MouseListener, MouseWheelListener {
