...
public class GameAction {
	...
	/* Initial press behavior. The isPressed() method returns true only after the key is first
	 * pressed, and not again until the key is released and pressed again.
	 */
	...
	// Resets this GameAction so that it appears like it hasn't been presed.
	public void reset() {
	...
	/* Signals the key was pressed a specific number of times, or that the 
	 * mouse moved a specific distance.
	 */
